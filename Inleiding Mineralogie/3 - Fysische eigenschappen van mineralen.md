...
*Bindingssterkte is bepalend* -> sterkere binding: grotere hardheid
...
***Orbitaal hopping***: door elektronen die springen tussen verschillende orbitalen zullen andere golflengtes geabsorbeerd worden afhankelijk van energie die opgenomen kan worden

Aard transitiemetalen:
- **Fe**: rood of groen
- **Mn**: roze
- **Cu**: groen/blauw
- **Cr**: rood/groen
...
## Kleurenspel
- **Inwendige reflectie** (briljantie)
...
### Fluorescentie
Enkel wanneer energiebron actief is
### Fosforescentie
